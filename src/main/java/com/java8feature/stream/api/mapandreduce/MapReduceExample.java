package com.java8feature.stream.api.mapandreduce;
...
public class MapReduceExample {
	...
	public static void main(String[] args) {
		...
		int maxValue = numbers.stream().reduce(2, (a, b) -> a > b ? a : b);
		System.out.println(maxValue);
		
		int maxvalueWithMethodReference = numbers.stream().reduce(Integer :: max).get();
